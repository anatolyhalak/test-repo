package ru.courses.answer.polimorfism.figureOfLines_2;


public class MainApp {
    public static void main(String[] args) {
        FigureOfLines figureOfLines = new FigureOfLines(new Point(0, 0), new Point(0, 1), new Point(1, 1));
        System.out.println(figureOfLines.getLinesLength());
    }
